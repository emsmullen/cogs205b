...
#get the date and make a new directory in data with that date, then move the csv files into that directory and remove the temporary directory and zip file - note that the date refers to UTC
dt=$(date '+%Y-%m-%d')
mkdir -p data/$dt
